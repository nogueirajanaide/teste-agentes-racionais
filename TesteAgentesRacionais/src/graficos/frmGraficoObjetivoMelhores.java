...
*/
public class frmGraficoObjetivoMelhores extends javax.swing.JFrame {
	...
	public frmGraficoObjetivoMelhores(ArrayList<Individuo> individuosSelecionados, String diretorio, String identificacao) {
		super();
	...
	private JFreeChart createChart() {
		...
		chart.setTitle(new TextTitle("Finad dos casos de testes selecionados", new Font("Arial", Font.BOLD, 16)));
