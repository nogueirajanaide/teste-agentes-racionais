...
*/
public class frmObjetivoGeracaoIndividual extends javax.swing.JFrame {
	...
	public frmObjetivoGeracaoIndividual(ArrayList<Individuo> individuosSelecionados, int geracao, String diretorio, String identificacao) {
		super();
	...
	private XYDataset obtemDataset() {
		...
		for (Individuo ind : individuosSelecionados) {
			if (ind.getSelecionado() && ind.getGeracao() == geracao) {
	...
	private JFreeChart createChart() {
		...
		JFreeChart chart = ChartFactory.createXYLineChart(
				"Objetivos na geração " + geracao, //title
				"Energia", //axis x
				"Limpeza", //axis y
				dataset, //data
		...
		chart.setTitle(new TextTitle("Objetivos na geração " + geracao, new Font("Arial", Font.BOLD, 16)));
