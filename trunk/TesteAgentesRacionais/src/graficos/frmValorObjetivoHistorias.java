...
*/
public class frmValorObjetivoHistorias extends javax.swing.JFrame {
	...
	public frmValorObjetivoHistorias(ArrayList<Individuo> individuosSelecionados, String diretorio, String identificacao) {
		super();
	...
	private XYDataset obtemDataset() {
		...
		for (Individuo ind : individuosSelecionados) {
			if (ind.getSelecionado()) {
				...
				//dataset.addValue(ind.fInad.get("Limpeza"), "Indivíduo selecionado", ind.fInad.get("Energia"));
				xySeries1.add(ind.fInad.get("Energia"), ind.fInad.get("Limpeza"));
				System.out.println("Selecionado Energia: " + ind.fInad.get("Energia") + " Limpeza: " + ind.fInad.get("Limpeza"));
			}
		}
		...
		for (Individuo ind : individuosSelecionados) {
			if (!ind.getSelecionado()) {
				...
				//System.out.println("Energia: " + ind.fInad.get("Energia") + " Limpeza: " + ind.fInad.get("Limpeza"));
			}
		}
		
		XYSeries xySeries3 = new XYSeries("Histórias");
		//Percorre cada historia para plotar o valor obtido nos objetivos
		int cont = 0;
		for(Individuo ind : individuosSelecionados)
		{
			...
			{
				//TODO: Ajustar aqui para ficar parametrizado!
				xySeries3.add(-h.avaliacao.get("Energia"), -h.avaliacao.get("Limpeza"));
				System.out.println("Historia L: " + -h.avaliacao.get("Limpeza") + " E: " + -h.avaliacao.get("Energia"));
				cont++;
			}
		}
	...
	private JFreeChart createChart() {
		...
		chart.setTitle(new TextTitle("Valor dos objetivos de cada história", new Font("Arial", Font.BOLD, 16)));
	    ...
	    renderer.setSeriesShape(2, ShapeUtilities.createRegularCross(1.5F, 1.5F));
